                            ...
                            @if($type == \App\Helpers\Business::PRICE_BY_TH1)
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="address_payment" value="{{(old('address_payment')) ? old('address_payment') : (($item) ? $item->address_payment : '') }}" name="address_payment" class="form-control price" placeholder="{{ __('label.address_payment') }}">
