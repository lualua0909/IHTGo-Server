...
<section class="content">
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <!--modal Tạo giao hàng (chọn tài xế & xe) -->
                                ...
                                <form role="form" action="{{route('delivery.store')}}" method="post" id="fr_delivery">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2 class_driver" id="id_driver" required name="driver_id" title="{{ __('label.driver') }}" style="width: 100%">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" id="id_car" required name="car_id" title="{{ __('label.car') }}" style="width: 100%">
                                                <option value="0" selected>{{ __('label.please_choose_field') }}</option>
                                            </select>
                            ...
                            <div class="row">
                                <form role="form" action="{{route('delivery.storeDriver')}}" method="post" id="fr_delivery_driver">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>{{ __('label.driver') }} (*)</label>
                                            <select class="form-control select2 class_driver" id="id_driver_only" required name="id_driver_only" title="{{ __('label.driver') }}" style="width: 100%">
                                                <option value="0" selected>{{ __('label.please_choose_field') }}</option>
                                            </select>
                    ...
                    <form role="form" action="{{route('order.warehouse')}}" method="post" id="fr_warehouse">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select class="form-control select2" id="id_warehouse" required name="id_warehouse" title="{{ __('label.warehouse') }}" style="width: 100%">
                                    <option value="0" selected>{{ __('label.please_choose_field') }}</option>
...
<!-- Modal hủy đơn hàng-->
<div class="modal fade" id="IHTGoCancel" role="dialog">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
