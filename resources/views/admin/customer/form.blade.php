                            ...
                            <div class="box box-primary">
                                ...
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <input {{ ($item) ? 'readonly' : '' }} type="text" required id="username" value="{{(old('username')) ? old('username') : (($item) ? $item->username : '') }}" name="username" class="form-control" placeholder="{{ __('label.username') }}">
