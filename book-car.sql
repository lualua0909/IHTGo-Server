...
CREATE DATABASE IF NOT EXISTS `book_cars` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `book_cars`;
...
-- Dumping data for table book_cars.customers: ~0 rows (approximately)
/*!40000 ALTER TABLE `customers` DISABLE KEYS */;
INSERT INTO `customers` (`id`, `user_id`, `type`, `address`, `phone_company`, `tax_code`, `deleted_at`, `created_at`, `updated_at`) VALUES
  (1, 1, 2, 'address', '0963256096', '12344321', NULL, '2018-06-22 20:36:34', '2018-06-22 20:36:34'),
  (2, 3, 2, 'address', '0963256096', '12344321', NULL, '2018-06-24 15:06:22', '2018-06-24 15:06:22');
...
INSERT INTO `evaluates` (`id`, `from_id`, `to_id`, `type`, `content`, `note`, `rate`, `created_at`, `updated_at`) VALUES
  (1, 1, 1, 1, '[{"name":"T\\u00e0i x\\u1ebf","comment":"Th\\u00e2n thi\\u1ec7n"}]', 'note', '5', '2018-06-24 15:14:02', '2018-06-24 15:14:02');
/*!40000 ALTER TABLE `evaluates` ENABLE KEYS */;

-- Dumping structure for table book_cars.management_prices
CREATE TABLE IF NOT EXISTS `management_prices` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
-- Dumping data for table book_cars.management_prices: ~0 rows (approximately)
/*!40000 ALTER TABLE `management_prices` DISABLE KEYS */;
INSERT INTO `management_prices` (`id`, `name`, `value`, `user_id`, `deleted_at`, `created_at`, `updated_at`) VALUES
  (1, 'sdsds', 'sdsd', 1, '2018-06-24 03:48:08', '2018-06-24 03:47:10', '2018-06-24 03:48:08');
/*!40000 ALTER TABLE `management_prices` ENABLE KEYS */;
...
-- Dumping data for table book_cars.migrations: ~7 rows (approximately)
...
-- Dumping data for table book_cars.others: ~0 rows (approximately)
...
-- Dumping data for table book_cars.users: ~3 rows (approximately)
/*!40000 ALTER TABLE `users` DISABLE KEYS */;
INSERT INTO `users` (`id`, `name`, `phone`, `username`, `code`, `email`, `gender`, `level`, `activated`, `baned`, `password`, `remember_token`, `created_at`, `updated_at`) VALUES
  (1, 'ThaiLe', '0963256096', NULL, NULL, 'admin@admin.com', 1, 1, 1, 0, '$2y$10$58RodRm2GDGmgYHEMrj44OHDptk.hCxJyt61/Y3FQ3GmpRFqUygQu', 'IYhq9mTtyyi3bqCySU9nWSU1UBpsfMcrM5WHtfLFZcNhzkgqZrRvxdGDjDrb', '2018-06-22 20:36:28', '2018-06-22 20:36:28'),
  (2, 'ThaiLe', '09632560961', NULL, NULL, '1@gmail.com', 1, 3, 1, 0, '$2y$10$58RodRm2GDGmgYHEMrj44OHDptk.hCxJyt61/Y3FQ3GmpRFqUygQu', 'IYhq9mTtyyi3bqCySU9nWSU1UBpsfMcrM5WHtfLFZcNhzkgqZrRvxdGDjDrb', '2018-06-22 20:36:28', '2018-06-22 20:36:28'),
  (3, 'ThaiLe', '0963256096', NULL, NULL, 'thaile.dev01@gmail.com', 1, 3, 0, 0, '$2y$10$A5GXLCcmjxci685V0XFmXeCfj4rS3gYXz/QQXQbCkMYRbiIhdLVs6', NULL, '2018-06-24 15:06:09', '2018-06-24 15:06:09');
