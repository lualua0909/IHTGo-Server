...
;(function ($, window, document, undefined) {
	...
	var defaults = {
		...
		'distanceAlert'            : 60,
		'dataType'                 : 'xml',
		'dataLocation'             : 'Store-Locator/dist/data/locations.xml',
		'dataRaw'                  : null,
		'xmlElement'               : 'marker',
		'listColor1'               : '#ffffff',
		'listColor2'               : '#eeeeee',
		...
		'dragSearch'               : false,
		'infowindowTemplatePath'   : 'Store-Locator/dist/assets/js/plugins/storeLocator/templates/infowindow-description.html',
		'listTemplatePath'         : 'Store-Locator/dist/assets/js/plugins/storeLocator/templates/location-list-description.html',
		'KMLinfowindowTemplatePath': 'Store-Locator/dist/assets/js/plugins/storeLocator/templates/kml-infowindow-description.html',
		'KMLlistTemplatePath'      : 'Store-Locator/dist/assets/js/plugins/storeLocator/templates/kml-location-list-description.html',
		'listTemplateID'           : null,
